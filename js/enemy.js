...
(function (){
	...
	var col = lj.enemy.types,
		...
		mod = lj.enemy.mods;
	//Brown
	col["brown"].a = new mon([2,2,25,1,1,1,2],"Wolf");
	col["brown"].b = new mon([3,1,20,0,1,2,0],"Gnoll");
	col["brown"].c = new mon([1,4,35,1,2,1,1],"Troll");
	col["brown"].d = new mon([3,2,40,1,1,5,0],"Undead Mage");
